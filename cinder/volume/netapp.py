...
class NetAppDirectISCSIDriver(driver.ISCSIDriver):
    ...
    def _create_client(self, **kwargs):
        ...
        # Use _invoke_succesfully instead to make sure
    ...
    def delete_volume(self, volume):
        ...
        lun_destroy = NaElement.create_node_with_children(
            ...
            **{'path': metadata['Path'],
            'force': 'true'})
        self._invoke_succesfully(lun_destroy, True)
    ...
    def _create_lun_on_eligible_vol(self, name, size, metadata):
        ...
        self._invoke_succesfully(lun_create, True)
    ...
    def _invoke_succesfully(self, na_element, do_tunneling=False):
    ...
    def _map_lun(self, name, initiator, initiator_type='iscsi', lun_id=None):
        ...
        try:
            result = self._invoke_succesfully(lun_map, True)
    ...
    def _unmap_lun(self, path, initiator):
        ...
        lun_unmap = NaElement.create_node_with_children(
            ...
            **{'path': path,
            'initiator-group': igroup_name})
        try:
            self._invoke_succesfully(lun_unmap, True)
        except NaApiError as e:
    ...
    def _create_igroup(self, igroup, igroup_type='iscsi', os_type='default'):
        ...
        igroup_create = NaElement.create_node_with_children(
            ...
            **{'initiator-group-name': igroup,
            ...
            'os-type': os_type})
        self._invoke_succesfully(igroup_create, True)
    ...
    def _add_igroup_initiator(self, igroup, initiator):
        ...
        igroup_add = NaElement.create_node_with_children(
            ...
            **{'initiator-group-name': igroup,
            'initiator': initiator})
        self._invoke_succesfully(igroup_add, True)
...
class NetAppDirectCmodeISCSIDriver(NetAppDirectISCSIDriver):
    ...
    def _get_avl_volume_by_size(self, size):
        ...
        while True:
            ...
            res = self._invoke_succesfully(vol_request)
    ...
    def _get_target_details(self):
        ...
        result = self._invoke_succesfully(iscsi_if_iter, True)
        tgt_list = []
    ...
    def _get_iscsi_service_details(self):
        ...
        result = self._invoke_succesfully(iscsi_service_iter, True)
    ...
    def _get_lun_list(self):
        ...
        while True:
            ...
            result = self._invoke_succesfully(api)
    ...
    def _get_lun_map(self, path):
        ...
        while True:
            ...
            result = self._invoke_succesfully(lun_map_iter, True)
            tag = result.get_child_content('next-tag')
            if result.get_child_content('num-records') and \
                    int(result.get_child_content('num-records')) >= 1:
                attr_list = result.get_child_by_name('attributes-list')
    ...
    def _get_igroup_by_initiator(self, initiator):
        ...
        while True:
            ...
            result = self._invoke_succesfully(igroup_iter, None)
            tag = result.get_child_content('next-tag')
            if result.get_child_content('num-records') and\
    ...
    def _clone_lun(self, name, new_name, space_reserved):
        ...
        self._invoke_succesfully(clone_create, True)
        LOG.debug(_("Cloned LUN with new name %s") % new_name)
    ...
    def _get_lun_by_args(self, **args):
        ...
        luns = self._invoke_succesfully(lun_iter)
...
class NetAppDirect7modeISCSIDriver(NetAppDirectISCSIDriver):
    ...
    def _do_custom_setup(self):
        ...
        if self.vfiler:
            self.client.set_api_version(1, 7)

    def _get_avl_volume_by_size(self, size):
        """Get the available volume by size"""
        vol_request = NaElement('volume-list-info')
        res = self._invoke_succesfully(vol_request, True)
    ...
    def _check_vol_not_root(self, vol):
        ...
        result = self._invoke_succesfully(vol_options, True)
    ...
    def _get_igroup_by_initiator(self, initiator):
        ...
        result = self._invoke_succesfully(igroup_list, True)
        igroups = []
    ...
    def _get_lun_list(self):
        ...
        result = self._invoke_succesfully(api, True)
    ...
    def _find_mapped_lun_igroup(self, path, initiator, os=None):
        ...
        lun_map_list = NaElement.create_node_with_children(
            'lun-map-list-info',
            **{'path': path})
        result = self._invoke_succesfully(lun_map_list, True)
    ...
    def _clone_lun(self, name, new_name, space_reserved):
        ...
        clone_start = NaElement.create_node_with_children(
            ...
            **{'source-path': path, 'destination-path': clone_path,
            'no-snap': 'true'})
        result = self._invoke_succesfully(clone_start, True)
        ...
        clone_ops_info = None
        while running:
            result = self._invoke_succesfully(clone_status, True)
    ...
    def _get_lun_by_args(self, **args):
        ...
        result = self._invoke_succesfully(lun_info, True)
        luns = result.get_child_by_name('luns')
        if luns:
    ...
    def _configure_tunneling(self, do_tunneling=False):
        ...
        if do_tunneling:
            self.client.set_vfiler_tunneling(self.vfiler)
        else:
            self.client.set_vfiler_tunneling(None)
...
class NaServer(object):
    ...
    def set_style(self, style):
        """Set the authorization style for communicating with the server
           Supports basic_auth and certificate_auth modes
        """
    ...
    def set_vfiler_tunneling(self, vfiler):
    ...
    def _create_request(self, na_element):
        ...
        if hasattr(self, '_vfiler') and self._vfiler:
            if hasattr(self, '_api_version') and self._api_version >= \
                    '1.7':
    ...
    def _create_basic_auth_handler(self):
        ...
        password_man.add_password(None, self._getUrl(), self._username,
                                  self._password)
